...
module.exports = function (RED) {
    function FunctionNode(n) {
        ...
        this.on('input', function (msg) {
            ...
            if(!node.url){
                node.url = 'https://openapi.naver.com/v1/search/news.json';
            }
    ...
    RED.nodes.registerType("navernews", FunctionNode, {
        credentials: {
            clientId: {type:"text"},
    ...
    function naverNewsApiKey(n){
        RED.nodes.createNode(this, n);
        this.clientId = n.clientId;
        this.clientSecret = n.clientSecret;
    }

    RED.nodes.registerType("naverNewsApiKey", naverNewsApiKey,{
        credentials: {
            clientId: {type:"text"},
            clientSecret: {type:"text"}
        }
